        ...
        <div className="inline-flex">
          <Link className="_o6689fn" to={"/"}>
            <div className="hidden md:block">
              <span class="bold-red">Village</span>
            </div>
          ...
          <div className="inline-block">
            <div className="inline-flex items-center max-w-full">
              ...
              <label htmlFor='my-modal-4' className='navbarAnyHold flex inpWidth2 cursor-pointer'>
                ...
                <p className=' text-gray-400 whitespace-nowrap '> Add your Children <AiOutlineSearch className=' whitespace-nowrap inline-block' /> </p>
              </label>
                        ...
                        <TabPanel>
                          <div className='tab3MainHold flex flex-col'>
                            ...
                            <div className='adultCriteriaHold flex flex-col relative'>
                              <p className=' text-gray-400'> Ages 4 to 12 </p>
                              <p className=' text-gray-400'> Ages 2-4 </p>
          ...
          <div className="flex justify-end items-center relative">
            <div className="flex mr-4 items-center">
              <div className="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                <div className="flex items-center relative cursor-pointer whitespace-nowrap">Start a childcare coop</div>
              </div>
